...
- (void) signIn:(CDVInvokedUrlCommand*)command {
    ...
    [signIn signInWithPresentingViewController:config presentingViewController:self.viewController callback:^(GIDGoogleUser * _Nullable user, NSError * _Nullable error) {
        if (error) {
